...
Model after restart has 470 rows, 736 cols (395 bin., 0 int., 0 impl., 341 cont., 0 dom.fix.), and 1490 nonzeros
         ...
         0       0         0   0.00%   12640.707748    15078             16.16%       17      0      0      1923     0.4s
         0       0         0   0.00%   12640.707748    15078             16.16%       17     17      7      1960     0.4s
...
Model after restart has 217 rows, 352 cols (197 bin., 0 int., 0 impl., 155 cont., 0 dom.fix.), and 679 nonzeros
         ...
         0       0         0   0.00%   13141.331139    15078             12.84%       18      0      0      2331     0.5s
         0       0         0   0.00%   13141.331139    15078             12.84%       18     12      6      2358     0.5s
...
Model after restart has 126 rows, 203 cols (119 bin., 0 int., 0 impl., 84 cont., 0 dom.fix.), and 383 nonzeros
         ...
         0       0         0   0.00%   13398.201013    15078             11.14%       13      0      0      2386     0.5s
         0       0         0   0.00%   13398.201013    15078             11.14%       13     12      2      2405     0.5s
...
Model after restart has 95 rows, 152 cols (92 bin., 0 int., 0 impl., 60 cont., 0 dom.fix.), and 289 nonzeros
         ...
         0       0         0   0.00%   13684.708977    15078              9.24%       18      0      0      2444     0.5s
         0       0         0   0.00%   13684.708977    15078              9.24%       18     14      2      2467     0.5s
...
Solving report
  ...
  LP iterations     2572
                    ...
                    204 (separation)
                    2090 (heuristics)
Model name          : p200x1188c
Model status        : Optimal
Simplex   iterations: 2572
IPM       iterations: -1
