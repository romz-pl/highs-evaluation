...
Src  Proc. InQueue |  Leaves   Expl. | BestBound       BestSol              Gap |   Cuts   InLp Confl. | LpIters     Time
 ...
 J       0       0         0   0.00%   -inf            0                  Large        0      0      0         0     0.2s
...
Model after restart has 3206 rows, 1041 cols (1012 bin., 0 int., 0 impl., 29 cont., 0 dom.fix.), and 18795 nonzeros
         ...
         0       0         0   0.00%   -4              0                  Large      240      0      0      7726     3.7s
         0       0         0   0.00%   -4              0                  Large      240     71      5      7926     3.7s
         2       0         1  50.00%   -4              0                  Large     3260    270      6     17644    10.1s
      1672      83       793  99.99%   -3              0                  Large     9620    157    943     51388    15.1s
      3535     129      1691  99.99%   -3              0                  Large     9212    180   2233     74083    20.1s

Restarting search from the root node
Model after restart has 2530 rows, 703 cols (674 bin., 0 int., 0 impl., 29 cont., 0 dom.fix.), and 14418 nonzeros

      3588       0         0   0.00%   -3              0                  Large      173      0      0     74930    20.3s
      3588       0         0   0.00%   -3              0                  Large      173     16      2     75018    20.3s
 T    4667       0       490 100.00%   -3              -3                 0.00%     4616    118    565     86756    22.5s
      4668       0       491 100.00%   -3              -3                 0.00%     4616    118    565     86764    22.5s
