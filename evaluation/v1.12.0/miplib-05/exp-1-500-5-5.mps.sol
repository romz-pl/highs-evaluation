...
Src  Proc. InQueue |  Leaves   Expl. | BestBound       BestSol              Gap |   Cuts   InLp Confl. | LpIters     Time
 ...
 R       0       0         0   0.00%   53374.134464    213649            75.02%     8348    594      0      1826     0.2s
 L       0       0         0   0.00%   65340.920452    74448             12.23%     9414    701      0      4503     1.4s
 L       0       0         0   0.00%   65340.920452    65887              0.83%     9414    701      0      7096     2.0s
...
Model after restart has 431 rows, 769 cols (146 bin., 0 int., 0 impl., 623 cont., 0 dom.fix.), and 1517 nonzeros
         ...
         0       0         0   0.00%   65504.892541    65887              0.58%      327      0      0      9178     2.0s
         0       0         0   0.00%   65504.892541    65887              0.58%      327    303      0      9709     2.0s
...
Model after restart has 404 rows, 723 cols (126 bin., 0 int., 0 impl., 597 cont., 0 dom.fix.), and 1420 nonzeros
         ...
         0       0         0   0.00%   65594.813296    65887              0.44%      290      0      0     10164     2.2s
         0       0         0   0.00%   65594.813296    65887              0.44%      290    283      0     10601     2.2s
...
Model after restart has 380 rows, 685 cols (107 bin., 0 int., 0 impl., 578 cont., 0 dom.fix.), and 1339 nonzeros
         ...
         0       0         0   0.00%   65666.927991    65887              0.33%      276      0      0     10974     2.3s
         0       0         0   0.00%   65666.927991    65887              0.33%      276    264      0     11399     2.3s
...
Model after restart has 347 rows, 633 cols (90 bin., 0 int., 0 impl., 543 cont., 0 dom.fix.), and 1227 nonzeros
         ...
         0       0         0   0.00%   65738.419671    65887              0.23%      250      0      0     11758     2.4s
         0       0         0   0.00%   65738.419671    65887              0.23%      250    237      0     12140     2.4s
...
Model after restart has 328 rows, 600 cols (80 bin., 0 int., 0 impl., 520 cont., 0 dom.fix.), and 1157 nonzeros
         ...
         0       0         0   0.00%   65785.817485    65887              0.15%      231      0      0     12577     2.5s
         0       0         0   0.00%   65785.817485    65887              0.15%      231    220      0     12916     2.5s
 L       0       0         0   0.00%   65793.334108    65887              0.14%      352    236      1     12943     2.6s
...
Model after restart has 314 rows, 578 cols (70 bin., 0 int., 0 impl., 508 cont., 0 dom.fix.), and 1112 nonzeros
         ...
         0       0         0   0.00%   65793.334108    65887              0.14%      213      0      0     13404     2.6s
         0       0         0   0.00%   65793.334108    65887              0.14%      213    204      0     13742     2.7s
...
Model after restart has 289 rows, 541 cols (55 bin., 0 int., 0 impl., 486 cont., 0 dom.fix.), and 1030 nonzeros
         ...
         0       0         0   0.00%   65817.652986    65887              0.11%      197      0      0     14027     2.7s
         0       0         0   0.00%   65817.652986    65887              0.11%      197    188      0     14313     2.8s
...
Src  Proc. InQueue |  Leaves   Expl. | BestBound       BestSol              Gap |   Cuts   InLp Confl. | LpIters     Time
         ...
         0       0         0   0.00%   65840.817733    65887              0.07%      180      0      0     14544     2.8s
         0       0         0   0.00%   65840.817733    65887              0.07%      180    165      0     14787     2.8s
...
Model after restart has 271 rows, 512 cols (41 bin., 0 int., 0 impl., 471 cont., 0 dom.fix.), and 971 nonzeros
         ...
         0       0         0   0.00%   65858.006531    65887              0.04%      158      0      0     14957     2.9s
...
Model after restart has 260 rows, 500 cols (33 bin., 0 int., 0 impl., 467 cont., 0 dom.fix.), and 943 nonzeros
         ...
         0       0         0   0.00%   65858.006629    65887              0.04%      134      0      0     15189     2.9s
         0       0         0   0.00%   65858.006629    65887              0.04%      134    117      0     15383     2.9s
...
Model after restart has 244 rows, 474 cols (27 bin., 0 int., 0 impl., 447 cont., 0 dom.fix.), and 893 nonzeros
         ...
         0       0         0   0.00%   65879.321891    65887              0.01%      106      0      0     15529     2.9s
         0       0         0   0.00%   65879.321891    65887              0.01%      106     95      0     15684     2.9s
         1       0         1 100.00%   65882.373786    65887              0.01%      140    103      0     15699     3.0s
