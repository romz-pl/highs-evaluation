...
Src  Proc. InQueue |  Leaves   Expl. | BestBound       BestSol              Gap |   Cuts   InLp Confl. | LpIters     Time
 ...
 J       0       0         0   0.00%   -inf            6118               Large        0      0      0         0     2.9s
         0       0         0   0.00%   2091.903421     6118              65.81%        0      0      2       421     3.0s
 L       0       0         0   0.00%   3050.035089     3201               4.72%       92     66      4      4329     8.1s
...
Model after restart has 430 rows, 525 cols (525 bin., 0 int., 0 impl., 0 cont., 0 dom.fix.), and 39321 nonzeros
         ...
         0       0         0   0.00%   3054.161114     3201               4.59%       53      0      0     10707     9.2s
         0       0         0   0.00%   3055.942821     3201               4.53%       53     52      7     11421     9.3s
...
Model after restart has 415 rows, 470 cols (470 bin., 0 int., 0 impl., 0 cont., 0 dom.fix.), and 34578 nonzeros
         ...
         0       0         0   0.00%   3063.025229     3201               4.31%       51      0      0     12210    10.1s
         0       0         0   0.00%   3063.696482     3201               4.29%       51     51      4     12904    10.1s
...
Model after restart has 383 rows, 390 cols (390 bin., 0 int., 0 impl., 0 cont., 0 dom.fix.), and 27450 nonzeros
         ...
         0       0         0   0.00%   3075.409658     3201               3.92%       50      0      0     13417    11.0s
         0       0         0   0.00%   3077.988144     3201               3.84%       50     46      4     13909    11.0s
...
Model after restart has 318 rows, 282 cols (282 bin., 0 int., 0 impl., 0 cont., 0 dom.fix.), and 18023 nonzeros
         ...
         0       0         0   0.00%   3089.438048     3201               3.49%       42      0      0     14180    11.5s
         0       0         0   0.00%   3091.366803     3201               3.42%       42     39      6     14622    11.5s
...
Model after restart has 269 rows, 206 cols (206 bin., 0 int., 0 impl., 0 cont., 0 dom.fix.), and 12123 nonzeros
         ...
         0       0         0   0.00%   3107.694245     3201               2.91%       33      0      0     14763    11.8s
         0       0         0   0.00%   3111.290252     3201               2.80%       33     32      4     15056    11.8s
...
Model after restart has 232 rows, 139 cols (139 bin., 0 int., 0 impl., 0 cont., 0 dom.fix.), and 7253 nonzeros
         ...
         0       0         0   0.00%   3140.875765     3201               1.88%       32      0      0     15721    12.0s
...
Model after restart has 71 rows, 33 cols (33 bin., 0 int., 0 impl., 0 cont., 0 dom.fix.), and 358 nonzeros
         ...
         0       0         0   0.00%   3167.277723     3201               1.05%       15      0      0     15941    12.0s
         1       0         1 100.00%   3201            3201               0.00%       15      0      0     15960    12.0s
