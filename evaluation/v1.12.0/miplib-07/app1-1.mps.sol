...
Model after restart has 3206 rows, 1041 cols (1012 bin., 0 int., 0 impl., 29 cont., 0 dom.fix.), and 18795 nonzeros
         ...
         0       0         0   0.00%   -4              0                  Large      240      0      0      7726     3.4s
         0       0         0   0.00%   -4              0                  Large      240     71      5      7926     3.4s
         2       0         1  50.00%   -4              0                  Large     3260    270      6     17644     9.1s
      1775      81       844  99.99%   -3              0                  Large     9987    173   1016     52693    14.1s

Restarting search from the root node
Model after restart has 2530 rows, 703 cols (674 bin., 0 int., 0 impl., 29 cont., 0 dom.fix.), and 14418 nonzeros

      3588       0         0   0.00%   -3              0                  Large      173      0      0     74930    18.7s
      3588       0         0   0.00%   -3              0                  Large      173     16      2     75018    18.7s
 T    4667       0       490 100.00%   -3              -3                 0.00%     4616    118    565     86756    20.9s
      4668       0       491 100.00%   -3              -3                 0.00%     4616    118    565     86764    20.9s
