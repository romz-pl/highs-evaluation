...
Src  Proc. InQueue |  Leaves   Expl. | BestBound       BestSol              Gap |   Cuts   InLp Confl. | LpIters     Time
 ...
 J       0       0         0   0.00%   -inf            59330              Large        0      0      0         0    16.2s
 R       0       0         0   0.00%   16310.666667    52674             69.03%        0      0      0       149    16.5s
 C       0       0         0   0.00%   16313.777778    21838             25.30%       54      6      0       210    18.7s
 L       0       0         0   0.00%   16313.777778    16862              3.25%       54      6      0       210    38.0s
...
Model after restart has 32 rows, 1410 cols (1410 bin., 0 int., 0 impl., 0 cont., 0 dom.fix.), and 10666 nonzeros
         ...
         0       0         0   0.00%   16313.777778    16862              3.25%        5      0      0      1296    44.7s
         0       0         0   0.00%   16313.833333    16862              3.25%        5      4      2      1335    44.7s
...
Model after restart has 32 rows, 1063 cols (1063 bin., 0 int., 0 impl., 0 cont., 0 dom.fix.), and 7977 nonzeros
         ...
         0       0         0   0.00%   16333.123922    16862              3.14%       20      0      0      1772    46.7s
         0       0         0   0.00%   16333.123922    16862              3.14%       20     19      2      1906    46.7s
...
Model after restart has 32 rows, 910 cols (910 bin., 0 int., 0 impl., 0 cont., 0 dom.fix.), and 6827 nonzeros
         ...
         0       0         0   0.00%   16447.485714    16862              2.46%       12      0      0      2480    47.8s
         0       0         0   0.00%   16447.485714    16862              2.46%       12     11      0      2520    47.8s
         1       0         1 100.00%   16862           16862              0.00%      458     25     52      4030    48.5s
