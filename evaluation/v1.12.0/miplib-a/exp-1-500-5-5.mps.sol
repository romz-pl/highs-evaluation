...
Src  Proc. InQueue |  Leaves   Expl. | BestBound       BestSol              Gap |   Cuts   InLp Confl. | LpIters     Time
 ...
 L       0       0         0   0.00%   65340.920452    65887              0.83%     9414    701      0      7096     1.7s
...
Model after restart has 328 rows, 600 cols (80 bin., 0 int., 0 impl., 520 cont., 0 dom.fix.), and 1157 nonzeros
         ...
         0       0         0   0.00%   65785.817485    65887              0.15%      231      0      0     12577     2.2s
         0       0         0   0.00%   65785.817485    65887              0.15%      231    220      0     12916     2.2s
 L       0       0         0   0.00%   65793.334108    65887              0.14%      352    236      1     12943     2.3s
...
Model after restart has 314 rows, 578 cols (70 bin., 0 int., 0 impl., 508 cont., 0 dom.fix.), and 1112 nonzeros
         ...
         0       0         0   0.00%   65793.334108    65887              0.14%      213      0      0     13404     2.3s
         0       0         0   0.00%   65793.334108    65887              0.14%      213    204      0     13742     2.3s
...
Model after restart has 289 rows, 541 cols (55 bin., 0 int., 0 impl., 486 cont., 0 dom.fix.), and 1030 nonzeros
         ...
         0       0         0   0.00%   65817.652986    65887              0.11%      197      0      0     14027     2.4s
         0       0         0   0.00%   65817.652986    65887              0.11%      197    188      0     14313     2.4s
...
Src  Proc. InQueue |  Leaves   Expl. | BestBound       BestSol              Gap |   Cuts   InLp Confl. | LpIters     Time
         ...
         0       0         0   0.00%   65840.817733    65887              0.07%      180      0      0     14544     2.5s
         0       0         0   0.00%   65840.817733    65887              0.07%      180    165      0     14787     2.5s
...
Model after restart has 271 rows, 512 cols (41 bin., 0 int., 0 impl., 471 cont., 0 dom.fix.), and 971 nonzeros
         ...
         0       0         0   0.00%   65858.006531    65887              0.04%      158      0      0     14957     2.5s
...
Model after restart has 260 rows, 500 cols (33 bin., 0 int., 0 impl., 467 cont., 0 dom.fix.), and 943 nonzeros
         ...
         0       0         0   0.00%   65858.006629    65887              0.04%      134      0      0     15189     2.5s
         0       0         0   0.00%   65858.006629    65887              0.04%      134    117      0     15383     2.5s
...
Model after restart has 244 rows, 474 cols (27 bin., 0 int., 0 impl., 447 cont., 0 dom.fix.), and 893 nonzeros
         ...
         0       0         0   0.00%   65879.321891    65887              0.01%      106      0      0     15529     2.6s
         0       0         0   0.00%   65879.321891    65887              0.01%      106     95      0     15684     2.6s
         1       0         1 100.00%   65882.373786    65887              0.01%      140    103      0     15699     2.6s
