...
Model after restart has 112 rows, 109 cols (37 bin., 72 int., 0 impl., 0 cont., 0 dom.fix.), and 936 nonzeros
         ...
         0       0         0   0.00%   2               inf                  inf       20      0      0      2229     0.2s
         0       0         0   0.00%   2               inf                  inf       20     13      4      2304     0.2s

Restarting search from the root node
Model after restart has 108 rows, 104 cols (34 bin., 70 int., 0 impl., 0 cont., 0 dom.fix.), and 875 nonzeros

       960       0         0   0.00%   2               inf                  inf       18      0      0      9090     0.9s
       960       0         0   0.00%   2               inf                  inf       18      8      2      9140     0.9s
      5792       0      2026 100.00%   inf             inf                  inf     1968     25   9991     45338     4.2s
