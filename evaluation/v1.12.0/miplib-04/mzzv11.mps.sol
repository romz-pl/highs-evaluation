...
8068 rows, 8295 cols, 132743 nonzeros  3s
6652 rows, 7205 cols, 105180 nonzeros  5s
5635 rows, 5897 cols, 84490 nonzeros  10s
...
Src  Proc. InQueue |  Leaves   Expl. | BestBound       BestSol              Gap |   Cuts   InLp Confl. | LpIters     Time
 ...
 J       0       0         0   0.00%   -inf            -300               Large        0      0      0         0    12.4s
         0       0         0   0.00%   -22419.388889   -300            7373.13%        0      0      3     25716    17.3s
         0       0         0   0.00%   -21817.825574   -300            7172.61%     7356    396    365     36703    22.7s
 L       0       0         0   0.00%   -21800.256984   -21698             0.47%     7664    266    365     39545    28.2s
...
Model after restart has 4024 rows, 3977 cols (3816 bin., 161 int., 0 impl., 0 cont., 0 dom.fix.), and 61705 nonzeros
         ...
         0       0         0   0.00%   -21797.577421   -21698             0.46%      146      0      0     45098    32.7s
         0       0         0   0.00%   -21794.290947   -21698             0.44%      146    105      6     61476    34.9s
 L       0       0         0   0.00%   -21778.608689   -21718             0.28%     1121    199      6     63988    38.2s
...
Model after restart has 3228 rows, 2906 cols (2763 bin., 143 int., 0 impl., 0 cont., 0 dom.fix.), and 45192 nonzeros
         ...
         0       0         0   0.00%   -21778.006729   -21718             0.28%      122      0      0     64652    40.1s
         0       0         0   0.00%   -21777.891397   -21718             0.28%      122     99      8     69616    40.6s
...
Model after restart has 2761 rows, 2480 cols (2226 bin., 131 int., 0 impl., 0 cont., 123 dom.fix.), and 40417 nonzeros
         ...
         0       0         0   0.00%   -21772.988929   -21718             0.25%      116      0      0     71432    43.8s
         0       0         0   0.00%   -21772.988929   -21718             0.25%      116     97      9     74693    44.1s
...
Model after restart has 2522 rows, 2218 cols (2090 bin., 128 int., 0 impl., 0 cont., 0 dom.fix.), and 36437 nonzeros
         ...
         0       0         0   0.00%   -21772.988233   -21718             0.25%      106      0      0     75829    45.6s
         0       0         0   0.00%   -21772.988233   -21718             0.25%      106     97      6     77802    45.7s
         1       0         1 100.00%   -21721.823158   -21718             0.02%      159     98    370     92729    49.4s
